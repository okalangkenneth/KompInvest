        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ThumbnailImage = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InvestmentPreferences = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MemberProfiles_Users_MemberID",
                        column: x => x.MemberID,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PerformanceData = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Investments", x => x.InvestmentID);
                    table.ForeignKey(
                        name: "FK_Investments_MemberProfiles_MemberID",
                        column: x => x.MemberID,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Testimonials_MemberProfiles_MemberID",
                        column: x => x.MemberID,
                        principalTable: "MemberProfiles",
                        principalColumn: "MemberID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Transactions_MemberProfiles_MemberID",
                        column: x => x.MemberID,
                        principalTable: "MemberProfiles",
                        principalColumn: "MemberID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Investments_MemberID_DateInvested",
                table: "Investments",
                columns: new[] { "MemberID", "DateInvested" });

            migrationBuilder.CreateIndex(
                name: "IX_NewsArticles_PublicationDate",
                table: "NewsArticles",
